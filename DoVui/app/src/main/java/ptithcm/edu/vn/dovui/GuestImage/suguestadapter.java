...
public class suguestadapter extends BaseAdapter {
    ...
    private GuestImageFood mainActivity;

    public suguestadapter(List<String> suggestSource, Context context, GuestImageFood mainActivity) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(String.valueOf(mainActivity.answer).contains(suggestSource.get(position)))
                        {
                            ...
                            //Update UI
                            quizadapter answerAdapter = new quizadapter(Common.user_submit_answer,context);
                            mainActivity.gridViewAnswer.setAdapter(answerAdapter);
                            answerAdapter.notifyDataSetChanged();

                            //Remove from suggest source
                            mainActivity.suggestSource.set(position,"null");
                            mainActivity.suggestAdapter = new suguestadapter(mainActivity.suggestSource,context,mainActivity);
